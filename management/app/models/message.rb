class Message < ActiveRecord::Base
  ...
  # The method call should expect 2 params (message, mailbox_type).
  ...
  #[empty method]
  #
  # this gets called when a message is delivered and 
  # the clean param is set (default). 
  # Implement this if you wish to clean out illegal 
  # content such as scripts or anything that will break layout. 
  # This is left empty because what is considered illegal content varies.
  def clean()
